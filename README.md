...
ถ้า Code.gs มีการเพิ่มคอลัมน์ใหม่ในชีต (เช่นรอบที่อัปเดตเรื่อง TIB/SS, จำนวนรอบระยะขยาย, แอดมิน) และ Google Sheet มีข้อมูลอยู่แล้ว **ห้ามรัน `setupSheets()` ซ้ำ** (จะไม่ทำอะไรเพราะเช็คว่ามีหัวคอลัมน์อยู่แล้ว) ให้รันฟังก์ชัน **`migrateSheets()`** แทน — จะเพิ่มคอลัมน์ที่ขาดต่อท้ายให้ โดยไม่ลบ/แก้ข้อมูลเดิม ปลอดภัย รันซ้ำได้หลายครั้ง
